...
class TestController extends Controller {
	...
	*/
        ...
        public function getGeocoding()
        {
          ...
          $d['a'] = \GoogleMaps::load('geocoding')                  
                ->setParamByKey('place_id', 'ChIJ82ENKDJgHTERIEjiXbIAAQE')
                ->get();
	...
	public function getDirections()
	{
		/**
		    ...
		    $d['z'] = \GoogleMaps::load('directions')
                         ->setParamByKey('origin', 'Lakewood, NJ')
                         ->setParamByKey('destination', 'Oak Park, MI')
                         ->get();
   ...
   public function getPlaceDetails(){
       ...
       $d =   \GoogleMaps::load('placedetails')      
                ->setParamByKey('placeid', 'ChIJ82ENKDJgHTERIEjiXbIAAQE')
   ...
   public function getPlaceAutoComplete(){
       ...
       $d =   \GoogleMaps::load('placeautocomplete')
                ->setParamByKey('input', 'Bankok Thailand')
